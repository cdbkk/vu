...
//!
//! Keep platform app-directory naming centralized so config, session,
//! auth, themes, and future storage paths do not drift.

use std::path::PathBuf;

#[cfg(target_os = "windows")]
pub const APP_DIR_NAME: &str = "vu-terminal";
#[cfg(not(target_os = "windows"))]
pub const APP_DIR_NAME: &str = "vu";
