...
//!
//! Unlike macOS, vu cannot embed Ghostty's renderer directly on Linux
//! today. The long-term Linux lane therefore matches the Windows
//! strategy in one important way: vu owns the backend integration
...
//! - GPUI-hosted terminal rendering in `vu-app/src/linux_view.rs`
//!
