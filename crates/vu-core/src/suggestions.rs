...
impl SuggestionEngine {
    ...
    pub fn request(
        ...
        if prefix.trim().is_empty() {
            log::debug!(target: "vu_core::suggestions", "skip ai suggestion: empty prefix");
            return;
        }
    ...
    pub fn cancel(&self) {
        log::debug!(target: "vu_core::suggestions", "cancel ai suggestion pending request");
...
async fn request_completion(
    ...
    match provider.complete(&prompt).await {
        ...
        Err(e) => {
            ...
            log::debug!(target: "vu_core::suggestions", "Suggestion completion failed: {}", e);
            None
        }
    }
}
