# vu Prototype Addendum — Visual Design Specifications
...
The following screenshots from Nowledge production demonstrate the target quality level for vu's light mode and component patterns:
...
From the Nowledge reference, vu should adopt:
